...
import { type SigninInput } from "@yash4903/medium-common"
...
export const SigninAuth = () =>{
    ...
    async function sendData(){
        try {
            const response = await axios.post(`${VITE_BACKEND_URL}/api/v1/user/signin`, userInput) 
    ...
    return <>
        ...
        <div className="mx-32 my-32">
            <div className="flex items-center justify-center flex-col mb-16">
                <h1 className="text-4xl tracking-tight font-extrabold ">Login</h1>
            ...
            <button onClick={sendData} className="w-full h-12 text-center shadow-2xl text-white bg-neutral-950 rounded-lg font-medium text-lg my-16 transition-all hover:bg-neutral-800 hover:scale-95">Sign In</button>
        </div>
